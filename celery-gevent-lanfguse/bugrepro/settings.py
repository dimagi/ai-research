"""
Django settings for bugrepro project.
...
SECRET_KEY = "django-insecure-s71q%)u1u)*&h)is=3a*p6#fc#za^vga-@=d52gxqk)p4g=j6@"
...
WSGI_APPLICATION = "bugrepro.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "bugrepro"),
